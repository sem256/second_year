...
namespace ConsoleTest
{
    class Program
    {
        ...
        static int yStart = (int)Registry.GetValue(w, "Task_Execution_Duration", 2),
            y = yStart,
            time = (int)Registry.GetValue(w, "Task_Execution_Quantity", 2);
        ...
        {
            int time = (int)Registry.GetValue(w, "Task_Execution_Duration", 60),
                prozent, numberOfI;
